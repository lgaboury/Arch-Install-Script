...
# 2.  It will wipe the drive, create an ESP and root partitions and will install systemd-boot boot loader. #
...
sgdisk -n 1:0:+300M -t 1:ef00 -n 2:0:0 -t 2:8300 /dev/nvme0n1
echo
sleep 5
...
options root=UUID=$(blkid -s UUID -o value /dev/nvme0n1p2) rw quiet loglevel=3 rd.systemd.show_status=auto rd.udev.log_level=3
EOF
